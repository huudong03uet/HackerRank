...
public static DoublyLinkedListNode sortedInsert(DoublyLinkedListNode llist, int data) {
            ...
            if(data < llist.data) {
                ...
                DoublyLinkedListNode result = llist;
                DoublyLinkedListNode right = llist.next;
                DoublyLinkedListNode left = llist;
                while (right != null && right.data < data) {
                    right = right.next;
                    left = left.next;
                }
                if(right == null) {
                    left.next = doublyLinkedListNode;
                    doublyLinkedListNode.prev = left;
                    return result;
                } else {
                    left.next = doublyLinkedListNode;
                    right.prev = doublyLinkedListNode;
                    doublyLinkedListNode.next = right;
                    doublyLinkedListNode.prev = left;
                    return result;
                }
            }
